...
function storeCustomer($customerInput){
    ...
    $sendimage = mysqli_real_escape_string($conn, $customerInput['sendimage']);
    
    
    
    $query = "INSERT INTO customers (name,email,phone,image) VALUES ('$name', '$email', '$phone', '$sendimage')";
...
function saveCustomer($customerInput){
